...
!function (window, document, undefined) {
  function is(A, e) {
    ...
    if ("object" == (typeof A === "undefined" ? "undefined" : (0, _typeof3.default)(A))) for (var t in A) {
      hasOwnProp(A, t) && addTest(t, A[t]);
    } else {
      A = A.toLowerCase();var r = A.split("."),
          n = Modernizr[r[0]];if (2 == r.length && (n = n[r[1]]), "undefined" != typeof n) return Modernizr;e = "function" == typeof e ? e() : e, 1 == r.length ? Modernizr[r[0]] = e : (!Modernizr[r[0]] || Modernizr[r[0]] instanceof Boolean || (Modernizr[r[0]] = new Boolean(Modernizr[r[0]])), Modernizr[r[0]][r[1]] = e), setClasses([(e && 0 != e ? "" : "no-") + r.join("-")]), Modernizr._trigger(A, e);
    }return Modernizr;
    ...
    var A = document.body;return A || (A = createElement(isSVG ? "svg" : "body"), A.fake = !0), A;
    ...
    var n,
        ...
        a = "modernizr",
        s = createElement("div"),
        l = getBody();if (parseInt(t, 10)) for (; t--;) {
      i = createElement("div"), i.id = r ? r[t] : a + (t + 1), s.appendChild(i);
    ...
    var r;if ("getComputedStyle" in window) {
      r = getComputedStyle.call(window, A, e);var n = window.console;if (null !== r) t && (r = r.getPropertyValue(t));else if (n) {
        var o = n.error ? "error" : "log";n[o].call(n, "getComputedStyle returning null, its possible modernizr test results are inaccurate");
      }
    } else r = !e && A.currentStyle && A.currentStyle[t];return r;
  }function roundedEquals(A, e) {
    return A - 1 === e || A === e || A + 1 === e;
  }function nativeTestProps(A, e) {
    var t = A.length;if ("CSS" in window && "supports" in window.CSS) {
      for (; t--;) {
    ...
    function n() {
      ...
      var o = nativeTestProps(A, t);if (!is(o, "undefined")) return o;
    }for (var i, d, a, s, l, c = ["modernizr", "tspan", "samp"]; !mStyle.style && c.length;) {
      i = !0, mStyle.modElem = createElement(c.shift()), mStyle.style = mStyle.modElem.style;
    }for (a = A.length, d = 0; a > d; d++) {
      if (s = A[d], l = mStyle.style[s], contains(s, "-") && (s = cssToDOM(s)), mStyle.style[s] !== undefined) {
        if (r || is(t, "undefined")) return n(), "pfx" == e ? s : !0;try {
          mStyle.style[s] = t;
        } catch (u) {}if (mStyle.style[s] != l) return n(), "pfx" == e ? s : !0;
      }
    }return n(), !1;
  }function fnBind(A, e) {
    return function () {
    ...
    var o = A.charAt(0).toUpperCase() + A.slice(1),
        i = (A + " " + cssomPrefixes.join(o + " ") + o).split(" ");return is(e, "string") || is(e, "undefined") ? testProps(i, e, r, n) : (i = (A + " " + domPrefixes.join(o + " ") + o).split(" "), testDOMProps(i, e, t));
  }function detectDeleteDatabase(A, e) {
    var t = A.deleteDatabase(e);t.onsuccess = function () {
    ...
    return testPropsAll(A, undefined, undefined, e, t);
      ...
      tests = [],
      ModernizrProto = { _version: "3.6.0", _config: { classPrefix: "", enableClasses: !0, enableJSClass: !0, usePrefixes: !0 }, _q: [], on: function on(A, e) {
      ...
      Modernizr = function Modernizr() {};Modernizr.prototype = ModernizrProto, Modernizr = new Modernizr(), Modernizr.addTest("cors", "XMLHttpRequest" in window && "withCredentials" in new XMLHttpRequest()), Modernizr.addTest("geolocation", "geolocation" in navigator), Modernizr.addTest("customelements", "customElements" in window), Modernizr.addTest("customprotocolhandler", function () {
    if (!navigator.registerProtocolHandler) return !1;try {
      navigator.registerProtocolHandler("thisShouldFail");
    } catch (A) {
      return A instanceof TypeError;
    }return !1;
  }), Modernizr.addTest("customevent", "CustomEvent" in window && "function" == typeof window.CustomEvent), Modernizr.addTest("dataview", "undefined" != typeof DataView && "getFloat64" in DataView.prototype), Modernizr.addTest("eventlistener", "addEventListener" in window), Modernizr.addTest("applicationcache", "applicationCache" in window), Modernizr.addTest("blobconstructor", function () {
    try {
      return !!new Blob();
    } catch (A) {
      return !1;
    ...
    var A = navigator.userAgent;return -1 === A.indexOf("Android 2.") && -1 === A.indexOf("Android 4.0") || -1 === A.indexOf("Mobile Safari") || -1 !== A.indexOf("Chrome") || -1 !== A.indexOf("Windows Phone") || "file:" === location.protocol ? window.history && "pushState" in window.history : !1;
    ...
    var supports;try {
      eval("``"), supports = !0;
    } catch (e) {}return !!supports;
  }), Modernizr.addTest("typedarrays", "ArrayBuffer" in window);var supports = !1;try {
    supports = "WebSocket" in window && 2 === window.WebSocket.CLOSING;
  } catch (e) {}Modernizr.addTest("websockets", supports), Modernizr.addTest("xdomainrequest", "XDomainRequest" in window), Modernizr.addTest("webaudio", function () {
    var A = "webkitAudioContext" in window,
        e = "AudioContext" in window;return Modernizr._config.usePrefixes ? A || e : e;
  });var CSS = window.CSS;Modernizr.addTest("cssescape", CSS ? "function" == typeof CSS.escape : !1), Modernizr.addTest("focuswithin", function () {
    try {
      ...
      oldSyntax = "supportsCSS" in window;Modernizr.addTest("supports", newSyntax || oldSyntax), Modernizr.addTest("target", function () {
    var A = window.document;if (!("querySelectorAll" in A)) return !1;try {
    ...
    var A = "2013-04-12T06:06:37.307Z",
        e = !1;try {
      e = !!Date.parse(A);
    } catch (t) {}return !!(Date.now && Date.prototype && Date.prototype.toISOString && Date.prototype.toJSON && e);
  ...
  }), Modernizr.addTest("es6array", !!(Array.prototype && Array.prototype.copyWithin && Array.prototype.fill && Array.prototype.find && Array.prototype.findIndex && Array.prototype.keys && Array.prototype.entries && Array.prototype.values && _from2.default && _of2.default)), Modernizr.addTest("arrow", function () {
    try {
      eval("()=>{}");
    } catch (e) {
      return !1;
  ...
  }), Modernizr.addTest("es6math", !!(Math && _clz2.default && _cbrt2.default && _imul2.default && _sign2.default && _log4.default && _log2.default && _log1p2.default && _expm2.default && _cosh2.default && _sinh2.default && _tanh2.default && _acosh2.default && _asinh2.default && _atanh2.default && _hypot2.default && _trunc2.default && _fround2.default)), Modernizr.addTest("es6number", !!(_isFinite2.default && _isInteger2.default && _isSafeInteger2.default && _isNan2.default && _parseInt2.default && _parseFloat2.default && (0, _isInteger2.default)(_maxSafeInteger2.default) && (0, _isInteger2.default)(_minSafeInteger2.default) && (0, _isFinite2.default)(_epsilon2.default))), Modernizr.addTest("es6object", !!(_assign2.default && _is2.default && _setPrototypeOf2.default)), Modernizr.addTest("promises", function () {
    return "Promise" in window && "resolve" in window.Promise && "reject" in window.Promise && "all" in window.Promise && "race" in window.Promise && function () {
      var A;return new window.Promise(function (e) {
        A = e;
      }), "function" == typeof A;
    }();
  }), Modernizr.addTest("es6string", !!(_fromCodePoint2.default && _raw2.default && String.prototype.codePointAt && String.prototype.repeat && String.prototype.startsWith && String.prototype.endsWith && String.prototype.includes)), Modernizr.addTest("devicemotion", "DeviceMotionEvent" in window), Modernizr.addTest("deviceorientation", "DeviceOrientationEvent" in window), Modernizr.addTest("filereader", !!(window.File && window.FileList && window.FileReader)), Modernizr.addTest("beacon", "sendBeacon" in navigator), Modernizr.addTest("lowbandwidth", function () {
    var A = navigator.connection || { type: 0 };return 3 == A.type || 4 == A.type || /^[23]g$/.test(A.type);
  ...
  }), Modernizr.addTest("urlsearchparams", "URLSearchParams" in window), Modernizr.addTest("getUserMedia", "mediaDevices" in navigator && "getUserMedia" in navigator.mediaDevices), Modernizr.addTest("websocketsbinary", function () {
    var A,
        e = "https:" == location.protocol ? "wss" : "ws";if ("WebSocket" in window) {
      if (A = "binaryType" in WebSocket.prototype) return A;try {
        return !!new WebSocket(e + "://.").binaryType;
      } catch (t) {}
    }return !1;
  }), Modernizr.addTest("atobbtoa", "atob" in window && "btoa" in window, { aliases: ["atob-btoa"] }), Modernizr.addTest("framed", window.location != top.location), Modernizr.addTest("sharedworkers", "SharedWorker" in window), Modernizr.addTest("webworkers", "Worker" in window);var prefixes = ModernizrProto._config.usePrefixes ? " -webkit- -moz- -o- -ms- ".split(" ") : ["", ""];ModernizrProto._prefixes = prefixes, Modernizr.addTest("contains", is(String.prototype.contains, "function"));var docElement = document.documentElement;Modernizr.addTest("contextmenu", "contextMenu" in docElement && "HTMLMenuItemElement" in window), Modernizr.addTest("cssall", "all" in docElement.style), Modernizr.addTest("willchange", "willChange" in docElement.style), Modernizr.addTest("classlist", "classList" in docElement), Modernizr.addTest("documentfragment", function () {
    return "createDocumentFragment" in document && "appendChild" in docElement;
  });var isSVG = "svg" === docElement.nodeName.toLowerCase(),
      html5;isSVG || !function (A, e) {
    function t(A, e) {
      var t = A.createElement("p"),
          r = A.getElementsByTagName("head")[0] || A.documentElement;return t.innerHTML = "x<style>" + e + "</style>", r.insertBefore(t.lastChild, r.firstChild);
    }function r() {
      var A = h.elements;return "string" == typeof A ? A.split(" ") : A;
    }function n(A, e) {
      var t = h.elements;"string" != typeof t && (t = t.join(" ")), "string" != typeof A && (A = A.join(" ")), h.elements = t + " " + A, s(e);
    }function o(A) {
      var e = E[A[f]];return e || (e = {}, g++, A[f] = g, E[g] = e), e;
    }function i(A, t, r) {
      if (t || (t = e), c) return t.createElement(A);r || (r = o(t));var n;return n = r.cache[A] ? r.cache[A].cloneNode() : m.test(A) ? (r.cache[A] = r.createElem(A)).cloneNode() : r.createElem(A), !n.canHaveChildren || w.test(A) || n.tagUrn ? n : r.frag.appendChild(n);
    }function d(A, t) {
      if (A || (A = e), c) return A.createDocumentFragment();t = t || o(A);for (var n = t.frag.cloneNode(), i = 0, d = r(), a = d.length; a > i; i++) {
        n.createElement(d[i]);
      }return n;
    }function a(A, e) {
      ...
      A || (A = e);var r = o(A);return !h.shivCSS || l || r.hasCSS || (r.hasCSS = !!t(A, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), c || a(A, r), A;
    }var l,
        c,
        u = "3.7.3",
        p = A.html5 || {},
        ...
        E = {};!function () {
      try {
        var A = e.createElement("a");A.innerHTML = "<xyz></xyz>", l = "hidden" in A, c = 1 == A.childNodes.length || function () {
          e.createElement("a");var A = e.createDocumentFragment();return "undefined" == typeof A.cloneNode || "undefined" == typeof A.createDocumentFragment || "undefined" == typeof A.createElement;
        }();
      } catch (t) {
        l = !0, c = !0;
      }
    }();var h = { elements: p.elements || "abbr article aside audio bdi canvas data datalist details dialog figcaption figure footer header hgroup main mark meter nav output picture progress section summary template time video", version: u, shivCSS: p.shivCSS !== !1, supportsUnknownElements: c, shivMethods: p.shivMethods !== !1, type: "default", shivDocument: s, createElement: i, createDocumentFragment: d, addElements: n };A.html5 = h, s(e), "object" == (typeof module === "undefined" ? "undefined" : (0, _typeof3.default)(module)) && module.exports && (module.exports = h);
  }("undefined" != typeof window ? window : this, document);var omPrefixes = "Moz O ms Webkit",
      domPrefixes = ModernizrProto._config.usePrefixes ? omPrefixes.toLowerCase().split(" ") : [];ModernizrProto._domPrefixes = domPrefixes;var hasOwnProp;!function () {
    var A = {}.hasOwnProperty;hasOwnProp = is(A, "undefined") || is(A.call, "undefined") ? function (A, e) {
    ...
    function A() {
      clearTimeout(e), window.removeEventListener("deviceproximity", A), addTest("proximity", !0);
        ...
        t = 300;"ondeviceproximity" in window && "onuserproximity" in window ? (window.addEventListener("deviceproximity", A), e = setTimeout(function () {
      window.removeEventListener("deviceproximity", A), addTest("proximity", !1);
    }, t)) : addTest("proximity", !1);
  }), Modernizr.addAsyncTest(function () {
    var A = new Image();A.onload = A.onerror = function () {
    ...
    function A(A, e, t) {
      function r(e) {
        var r = e && "load" === e.type ? 1 == n.width : !1,
            o = "webp" === A;addTest(A, o && r ? new Boolean(r) : r), t && t(e);
      }var n = new Image();n.onerror = r, n.onload = r, n.src = e;
    }var e = [{ uri: "data:image/webp;base64,UklGRiQAAABXRUJQVlA4IBgAAAAwAQCdASoBAAEAAwA0JaQAA3AA/vuUAAA=", name: "webp" }, { uri: "data:image/webp;base64,UklGRkoAAABXRUJQVlA4WAoAAAAQAAAAAAAAAAAAQUxQSAwAAAABBxAR/Q9ERP8DAABWUDggGAAAADABAJ0BKgEAAQADADQlpAADcAD++/1QAA==", name: "webp.alpha" }, { uri: "data:image/webp;base64,UklGRlIAAABXRUJQVlA4WAoAAAASAAAAAAAAAAAAQU5JTQYAAAD/////AABBTk1GJgAAAAAAAAAAAAAAAAAAAGQAAABWUDhMDQAAAC8AAAAQBxAREYiI/gcA", name: "webp.animation" }, { uri: "data:image/webp;base64,UklGRh4AAABXRUJQVlA4TBEAAAAvAAAAAAfQ//73v/+BiOh/AAA=", name: "webp.lossless" }],
        t = e.shift();A(t.name, t.uri, function (t) {
      if (t && "load" === t.type) for (var r = 0; r < e.length; r++) {
        A(e[r].name, e[r].uri);
      }
    });
    ...
    function A() {
      ...
      addTest("datauri", !1);
    }, 10);var e = new Image();e.onerror = function () {
      addTest("datauri", !1);
    }, e.onload = function () {
    ...
    function A() {
      ...
      var t = window.BlobBuilder,
          r = window.URL;Modernizr._config.usePrefix && (t = t || window.MozBlobBuilder || window.WebKitBlobBuilder || window.MSBlobBuilder || window.OBlobBuilder, r = r || window.MozURL || window.webkitURL || window.MSURL || window.OURL);var n,
          o,
          i,
          d,
          a,
          s = "Modernizr",
          l = "this.onmessage=function(e){postMessage(e.data)}";try {
        n = new Blob([l], { type: "text/javascript" });
      } catch (c) {}n || (o = new t(), o.append(l), n = o.getBlob()), d = r.createObjectURL(n), i = new Worker(d), i.onmessage = function (A) {
    ...
    try {
      var A = "Modernizr",
          e = new Worker("data:text/javascript;base64,dGhpcy5vbm1lc3NhZ2U9ZnVuY3Rpb24oZSl7cG9zdE1lc3NhZ2UoZS5kYXRhKX0=");e.onmessage = function (t) {
  ...
  });var cssomPrefixes = ModernizrProto._config.usePrefixes ? omPrefixes.split(" ") : [];ModernizrProto._cssomPrefixes = cssomPrefixes;var atRule = function atRule(A) {
    var e,
        t = prefixes.length,
        r = window.CSSRule;if ("undefined" == typeof r) return undefined;if (!A) return !1;if (A = A.replace(/^@/, ""), e = A.replace(/-/g, "_").toUpperCase() + "_RULE", e in r) return "@" + A;for (var n = 0; t > n; n++) {
      var o = prefixes[n],
          i = o.toUpperCase() + "_" + e;if (i in r) return "@-" + o.toLowerCase() + "-" + A;
    }return !1;
  };ModernizrProto.atRule = atRule;var hasEvent = function () {
    function A(A, t) {
      var r;return A ? (t && "string" != typeof t || (t = createElement(t || "div")), A = "on" + A, r = A in t, !r && e && (t.setAttribute || (t = createElement("div")), t.setAttribute(A, ""), r = "function" == typeof t[A], t[A] !== undefined && (t[A] = undefined), t.removeAttribute(A)), r) : !1;
    }var e = !("onblur" in document.documentElement);return A;
  ...
  }), Modernizr.addTest("ambientlight", hasEvent("devicelight", window)), Modernizr.addTest("inputsearchevent", hasEvent("search")), Modernizr.addTest("pointerevents", function () {
    var A = !1,
        e = domPrefixes.length;for (A = Modernizr.hasEvent("pointerdown"); e-- && !A;) {
      hasEvent(domPrefixes[e] + "pointerdown") && (A = !0);
    }return A;
  });var prefixedCSSValue = function prefixedCSSValue(A, e) {
    var t = !1,
        r = createElement("div"),
        n = r.style;if (A in n) {
      var o = domPrefixes.length;for (n[A] = e, t = n[A]; o-- && !t;) {
    ...
    var A = createElement("canvas");return !(!A.getContext || !A.getContext("2d"));
  }), Modernizr.addTest("canvastext", function () {
    return Modernizr.canvas === !1 ? !1 : "function" == typeof createElement("canvas").getContext("2d").fillText;
  }), Modernizr.addTest("emoji", function () {
    if (!Modernizr.canvastext) return !1;var A = window.devicePixelRatio || 1,
        e = 12 * A,
        t = createElement("canvas"),
        r = t.getContext("2d");return r.fillStyle = "#f00", r.textBaseline = "top", r.font = "32px Arial", r.fillText("🐨", 0, 0), 0 !== r.getImageData(e, e, 1, 1).data[0];
  }), Modernizr.addTest("contenteditable", function () {
    if ("contentEditable" in docElement) {
      var A = createElement("div");return A.contentEditable = !0, "true" === A.contentEditable;
    }
    ...
    var A,
        e = createElement("div"),
        t = !1;return isSVG || (e.innerHTML = '<v:shape id="vml_flag1" adj="1" />', A = e.firstChild, "style" in A && (A.style.behavior = "url(#default#VML)"), t = A ? "object" == (0, _typeof3.default)(A.adj) : !0), t;
  }), Modernizr.addTest("webanimations", "animate" in createElement("div")), Modernizr.addTest("webgl", function () {
    var A = createElement("canvas"),
        e = "probablySupportsContext" in A ? "probablySupportsContext" : "supportsContext";return e in A ? A[e]("webgl") || A[e]("experimental-webgl") : "WebGLRenderingContext" in window;
    ...
    function A(t) {
      clearTimeout(e);var n = t !== undefined && "loadeddata" === t.type ? !0 : !1;r.removeEventListener("loadeddata", A, !1), addTest("audiopreload", n), r.parentNode && r.parentNode.removeChild(r);
    }var e,
        t = 300,
        r = createElement("audio"),
        n = r.style;if (!(Modernizr.audio && "preload" in r)) return void addTest("audiopreload", !1);n.position = "absolute", n.height = 0, n.width = 0;try {
    ...
    if (Modernizr.canvas === !1) return !1;var A = createElement("canvas").getContext("2d");try {
      A.globalCompositeOperation = "screen";
    } catch (e) {}return "screen" === A.globalCompositeOperation;
  });var canvas = createElement("canvas");Modernizr.addTest("todataurljpeg", function () {
    ...
    if (Modernizr.canvas === !1) return !1;var A = createElement("canvas").getContext("2d");return A.rect(0, 0, 10, 10), A.rect(2, 2, 6, 6), A.isPointInPath(5, 5, "evenodd") === !1;
  }), Modernizr.addTest("bgpositionshorthand", function () {
    var A = createElement("a"),
        e = A.style,
        t = "right 10px bottom 10px";return e.cssText = "background-position: " + t + ";", e.backgroundPosition === t;
  }), Modernizr.addTest("csscalc", function () {
    var A = "width:",
        e = "calc(10px);",
        t = createElement("a");return t.style.cssText = A + prefixes.join(e + A), !!t.style.length;
  }), Modernizr.addTest("cubicbezierrange", function () {
    var A = createElement("a");return A.style.cssText = prefixes.join("transition-timing-function:cubic-bezier(1,0,0,1.1); "), !!A.style.length;
  }), Modernizr.addTest("cssgradients", function () {
    for (var A, e = "background-image:", t = "gradient(linear,left top,right bottom,from(#9f9),to(white));", r = "", n = 0, o = prefixes.length - 1; o > n; n++) {
      A = 0 === n ? "to " : "", r += e + prefixes[n] + "linear-gradient(" + A + "left top, #9f9, white);";
    }Modernizr._config.usePrefixes && (r += e + "-webkit-" + t);var i = createElement("a"),
        d = i.style;return d.cssText = r, ("" + d.backgroundImage).indexOf("gradient") > -1;
  }), Modernizr.addTest("multiplebgs", function () {
    var A = createElement("a").style;return A.cssText = "background:url(https://),url(https://),red url(https://)", /(url\s*\(.*?){3}/.test(A.background);
  }), Modernizr.addTest("opacity", function () {
    var A = createElement("a").style;return A.cssText = prefixes.join("opacity:.55;"), /^0.55$/.test(A.opacity);
  }), Modernizr.addTest("csspointerevents", function () {
    var A = createElement("a").style;return A.cssText = "pointer-events:auto", "auto" === A.pointerEvents;
  }), Modernizr.addTest("csspositionsticky", function () {
    var A = "position:",
        e = "sticky",
        t = createElement("a"),
        r = t.style;return r.cssText = A + prefixes.join(e + ";" + A).slice(0, -A.length), -1 !== r.position.indexOf(e);
  }), Modernizr.addTest("cssremunit", function () {
    var A = createElement("a").style;try {
      A.fontSize = "3rem";
    } catch (e) {}return (/rem/.test(A.fontSize)
    );
  }), Modernizr.addTest("rgba", function () {
    var A = createElement("a").style;return A.cssText = "background-color:rgba(150,255,150,.5)", ("" + A.backgroundColor).indexOf("rgba") > -1;
    ...
    var A = createElement("div");return A.setAttribute("data-a-b", "c"), !(!A.dataset || "c" !== A.dataset.aB);
    ...
    function A(A, e) {
      var t;return window.getComputedStyle ? t = document.defaultView.getComputedStyle(A, null).getPropertyValue(e) : A.currentStyle && (t = A.currentStyle[e]), t;
    }function e() {
      docElement.removeChild(t), t = null, r = null, n = null;
        ...
        n = createElement("rp"),
        o = "display",
        i = "fontSize";return t.appendChild(n), t.appendChild(r), docElement.appendChild(t), "none" == A(n, o) || "ruby" == A(t, o) && "ruby-text" == A(r, o) || "6pt" == A(n, i) && "6pt" == A(r, i) ? (e(), !0) : (e(), !1);
    ...
    var A = createElement("a");return A.innerHTML = "<xyz></xyz>", 1 === A.childNodes.length;
  }), Modernizr.addTest("capture", "capture" in createElement("input")), Modernizr.addTest("fileinput", function () {
    if (navigator.userAgent.match(/(Android (1.0|1.1|1.5|1.6|2.0|2.1))|(Windows Phone (OS 7|8.0))|(XBLWP)|(ZuneWP)|(w(eb)?OSBrowser)|(webOS)|(Kindle\/(1.0|2.0|2.5|3.0))/)) return !1;var A = createElement("input");return A.type = "file", !A.disabled;
  }), Modernizr.addTest("fileinputdirectory", function () {
    var A = createElement("input"),
        e = "directory";if (A.type = "file", e in A) return !0;for (var t = 0, r = domPrefixes.length; r > t; t++) {
    ...
    if (!Modernizr.canvas) return !1;var A = new Image(),
        e = createElement("canvas"),
        t = e.getContext("2d");A.onload = function () {
    ...
    var A,
        ...
        t,
        r = createElement("img"),
        n = "sizes" in r;!n && "srcset" in r ? (e = "data:image/gif;base64,R0lGODlhAgABAPAAAP///wAAACH5BAAAAAAALAAAAAACAAEAAAICBAoAOw==", A = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==", t = function t() {
    ...
    var A = createElement("div");return A.innerHTML = "<svg/>", "http://www.w3.org/2000/svg" == ("undefined" != typeof SVGRect && A.firstChild && A.firstChild.namespaceURI);
  }), Modernizr.addTest("textareamaxlength", !!("maxLength" in createElement("textarea"))), Modernizr.addAsyncTest(function () {
    function A(i) {
      n++, clearTimeout(e);var d = i && "playing" === i.type || 0 !== o.currentTime;return !d && r > n ? void (e = setTimeout(A, t)) : (o.removeEventListener("playing", A, !1), addTest("videoautoplay", d), void (o.parentNode && o.parentNode.removeChild(o)));
    }var e,
        t = 200,
        r = 5,
        n = 0,
        o = createElement("video"),
        i = o.style;if (!(Modernizr.video && "autoplay" in o)) return void addTest("videoautoplay", !1);i.position = "absolute", i.height = 0, i.width = 0;try {
    ...
    }o.setAttribute("autoplay", ""), i.cssText = "display:none", docElement.appendChild(o), setTimeout(function () {
    ...
    if (Modernizr.webglextensions = !1, Modernizr.webgl) {
      var A, e, t;try {
        ...
        return;
      }e !== undefined && (Modernizr.webglextensions = new Boolean(!0));for (var n = -1, o = t.length; ++n < o;) {
    ...
    var A,
      ...
      A.fake && A.parentNode && A.parentNode.removeChild(A);
        ...
        n = function n(A, e) {
      var t = !!A;if (t && (t = new Boolean(t), t.blocked = "blocked" === A), addTest("flash", function () {
        return t;
      }), e && s.contains(e)) {
        for (; e.parentNode !== s;) {
          e = e.parentNode;
    ...
    } catch (o) {}if (A = !("plugins" in navigator && "Shockwave Flash" in navigator.plugins || e), A || isSVG) n(!1);else {
      var _i,
          d,
          a = createElement("embed"),
          s = getBody();if (a.type = "application/x-shockwave-flash", s.appendChild(a), !("Pan" in a || e)) return t(s), n("blocked", a), void r(s);_i = function i() {
        return t(s), docElement.contains(s) ? (docElement.contains(a) ? (d = a.style.cssText, "" !== d ? n("blocked", a) : n(!0, a)) : n("blocked"), void r(s)) : (s = document.body || s, a = createElement("embed"), a.type = "application/x-shockwave-flash", s.appendChild(a), setTimeout(_i, 1e3));
      }, setTimeout(_i, 10);
    }
  });var mq = function () {
    var A = window.matchMedia || window.msMatchMedia;return A ? function (e) {
      var t = A(e);return t && t.matches || !1;
    } : function (A) {
      var e = !1;return injectElementWithStyles("@media " + A + " { #modernizr { position: absolute; } }", function (A) {
        e = "absolute" == (window.getComputedStyle ? window.getComputedStyle(A, null) : A.currentStyle).position;
      }), e;
    };
  }();ModernizrProto.mq = mq, Modernizr.addTest("mediaqueries", mq("only all")), Modernizr.addTest("hovermq", mq("(hover)")), Modernizr.addTest("pointermq", mq("(pointer:coarse),(pointer:fine),(pointer:none)"));var testStyles = ModernizrProto.testStyles = injectElementWithStyles;Modernizr.addTest("hiddenscroll", function () {
    return testStyles("#modernizr {width:100px;height:100px;overflow:scroll}", function (A) {
      return A.offsetWidth === A.clientWidth;
    });
  }), Modernizr.addTest("mathml", function () {
    var A;return testStyles("#modernizr{position:absolute;display:inline-block}", function (e) {
      e.innerHTML += "<math><mfrac><mi>xx</mi><mi>yy</mi></mfrac></math>", A = e.offsetHeight > e.offsetWidth;
    }), A;
  }), Modernizr.addTest("touchevents", function () {
    var A;if ("ontouchstart" in window || window.DocumentTouch && document instanceof DocumentTouch) A = !0;else {
      var e = ["@media (", prefixes.join("touch-enabled),("), "heartz", ")", "{#modernizr{top:9px;position:absolute}}"].join("");testStyles(e, function (e) {
        A = 9 === e.offsetTop;
      });
    }return A;
    ...
    return Modernizr.testStyles('@font-face{font-family:"unicodeRange";src:local("Arial");unicode-range:U+0020,U+002E}#modernizr span{font-size:20px;display:inline-block;font-family:"unicodeRange",monospace}#modernizr .mono{font-family:monospace}', function (A) {
      for (var e = [".", ".", "m", "m"], t = 0; t < e.length; t++) {
        var r = createElement("span");r.innerHTML = e[t], r.className = t % 2 ? "mono" : "", A.appendChild(r), e[t] = r.clientWidth;
      }return e[0] !== e[1] && e[2] === e[3];
    });
  }), Modernizr.addTest("unicode", function () {
    var A,
        e = createElement("span"),
        t = createElement("span");return testStyles("#modernizr{font-family:Arial,sans;font-size:300em;}", function (r) {
    ...
    return testStyles("#modernizr {position:absolute} #modernizr input {margin-left:10px} #modernizr :checked {margin-left:20px;display:block}", function (A) {
      var e = createElement("input");return e.setAttribute("type", "checkbox"), e.setAttribute("checked", "checked"), A.appendChild(e), 20 === e.offsetLeft;
    });
  }), testStyles("#modernizr{display: table; direction: ltr}#modernizr div{display: table-cell; padding: 10px}", function (A) {
    var e,
        t = A.childNodes;e = t[0].offsetLeft < t[1].offsetLeft, Modernizr.addTest("displaytable", e, { aliases: ["display-table"] });
  }, 2);var blacklist = function () {
    ...
    var t = document.getElementById("smodernizr"),
        ...
        o = /src/i.test(n) && 0 === n.indexOf(e.split(" ")[0]);Modernizr.addTest("fontface", o);
    ...
    return testStyles("#modernizr input{height:0;border:0;padding:0;margin:0;width:10px} #modernizr input:invalid{width:50px}", function (A) {
      var e = createElement("input");return e.required = !0, A.appendChild(e), e.clientWidth > 10;
    });
    ...
    var e = A.firstChild;e.innerHTML = "This is a text written in Arial", Modernizr.addTest("subpixelfont", window.getComputedStyle ? "44px" !== window.getComputedStyle(e, null).getPropertyValue("width") : !1);
    ...
    return testStyles("#modernizr input{height:0;border:0;padding:0;margin:0;width:10px} #modernizr input:valid{width:50px}", function (A) {
      var e = createElement("input");return A.appendChild(e), e.clientWidth > 10;
    });
  }), Modernizr.addTest("details", function () {
    var A,
        e = createElement("details");return "open" in e ? (testStyles("#modernizr details{display:block}", function (t) {
      t.appendChild(e), e.innerHTML = "<summary>a</summary>b", A = e.offsetHeight, e.open = !0, A = A != e.offsetHeight;
    }), A) : !1;
  }), Modernizr.addTest("oninput", function () {
    var A,
        e = createElement("input");if (e.setAttribute("oninput", "return"), hasEvent("oninput", docElement) || "function" == typeof e.oninput) return !0;try {
      var t = document.createEvent("KeyboardEvent");
      A = !1;var r = function r(e) {
    ...
    var A = createElement("form");if (!("checkValidity" in A && "addEventListener" in A)) return !1;if ("reportValidity" in A) return !0;var e,
        t = !1;return Modernizr.formvalidationapi = !0, A.addEventListener("submit", function (A) {
      ...
      attrs = {};Modernizr.input = function (A) {
  ...
  }(inputattrs), Modernizr.addTest("datalistelem", Modernizr.input.list);var inputtypes = "search tel url email datetime date month week time datetime-local number range color".split(" "),
      inputs = {};Modernizr.inputtypes = function (A) {
    for (var e, t, r, n = A.length, o = "1)", i = 0; n > i; i++) {
      inputElem.setAttribute("type", e = A[i]), r = "text" !== inputElem.type && "style" in inputElem, r && (inputElem.value = o, inputElem.style.cssText = "position:absolute;visibility:hidden;", /^range$/.test(e) && inputElem.style.WebkitAppearance !== undefined ? (docElement.appendChild(inputElem), t = document.defaultView, r = t.getComputedStyle && "textfield" !== t.getComputedStyle(inputElem, null).WebkitAppearance && 0 !== inputElem.offsetHeight, docElement.removeChild(inputElem)) : /^(search|tel)$/.test(e) || (r = /^(url|email)$/.test(e) ? inputElem.checkValidity && inputElem.checkValidity() === !1 : inputElem.value != o)), inputs[A[i]] = !!r;
    }return inputs;
  }(inputtypes), Modernizr.addTest("localizednumber", function () {
    if (!Modernizr.inputtypes.number) return !1;if (!Modernizr.formvalidation) return !1;var A,
        e = createElement("div"),
        t = getBody(),
        r = function () {
      return docElement.insertBefore(t, docElement.firstElementChild || docElement.firstChild);
    }();e.innerHTML = '<input type="number" value="1.0" step="0.1"/>';var n = e.childNodes[0];r.appendChild(e), n.focus();try {
      document.execCommand("SelectAll", !1), document.execCommand("InsertText", !1, "1,1");
    } catch (o) {}return A = "number" === n.type && 1.1 === n.valueAsNumber && n.checkValidity(), r.removeChild(e), t.fake && r.parentNode.removeChild(r), A;
  });var modElem = { elem: createElement("modernizr") };Modernizr._q.push(function () {
    delete modElem.elem;
  }), Modernizr.addTest("csschunit", function () {
    var A,
        e = modElem.elem.style;try {
    ...
    var A = createElement("a").style;return A.cssText = "background-color:hsla(120,40%,100%,.5)", contains(A.backgroundColor, "rgba") || contains(A.backgroundColor, "hsla");
  }), Modernizr.addTest("bdi", function () {
    var A = createElement("div"),
        e = createElement("bdi");e.innerHTML = "&#1573;", A.appendChild(e), docElement.appendChild(A);var t = "rtl" === computedStyle(e, null, "direction");return docElement.removeChild(A), t;
  }), testStyles("#modernizr { height: 50vh; }", function (A) {
    var e = parseInt(window.innerHeight / 2, 10),
        t = parseInt(computedStyle(A, null, "height"), 10);Modernizr.addTest("cssvhunit", roundedEquals(t, e));
    ...
    var e = A.childNodes[2],
        ...
        a = parseInt(computedStyle(e, null, "width"), 10);Modernizr.addTest("cssvmaxunit", roundedEquals(d, a) || roundedEquals(d, a - n));
    ...
    var e = A.childNodes[2],
        ...
        a = parseInt(computedStyle(e, null, "width"), 10);Modernizr.addTest("cssvminunit", roundedEquals(d, a) || roundedEquals(d, a - n));
  }, 3), testStyles("#modernizr { width: 50vw; }", function (A) {
    var e = parseInt(window.innerWidth / 2, 10),
        t = parseInt(computedStyle(A, null, "width"), 10);Modernizr.addTest("cssvwunit", roundedEquals(t, e));
  });var testXhrType = function testXhrType(A) {
    if ("undefined" == typeof XMLHttpRequest) return !1;var e = new XMLHttpRequest();e.open("get", "/", !0);try {
      e.responseType = A;
    } catch (t) {
      return !1;
    }return "response" in e && e.responseType == A;
  };Modernizr.addTest("xhrresponsetypearraybuffer", testXhrType("arraybuffer")), Modernizr.addTest("xhrresponsetypeblob", testXhrType("blob")), Modernizr.addTest("xhrresponsetypedocument", testXhrType("document")), Modernizr.addTest("xhrresponsetypejson", testXhrType("json")), Modernizr.addTest("xhrresponsetypetext", testXhrType("text"));var toStringFn = {}.toString;Modernizr.addTest("svgclippaths", function () {
  ...
  };Modernizr.addTest("textshadow", testProp("textShadow", "1px 1px")), ModernizrProto.testAllProps = testPropsAll;var prefixed = ModernizrProto.prefixed = function (A, e, t) {
    ...
    var e = prefixed(A);return e && domToCSS(e);
  };Modernizr.addTest("gamepads", !!prefixed("getGamepads", navigator));var crypto = prefixed("crypto", window);Modernizr.addTest("crypto", !!prefixed("subtle", crypto)), Modernizr.addTest("dart", !!prefixed("startDart", navigator)), Modernizr.addTest("batteryapi", !!prefixed("battery", navigator), { aliases: ["battery-api"] }), Modernizr.addTest("forcetouch", function () {
  ...
  }), Modernizr.addTest("fullscreen", !(!prefixed("exitFullscreen", document, !1) && !prefixed("cancelFullScreen", document, !1))), Modernizr.addAsyncTest(function () {
    var A;try {
      A = prefixed("indexedDB", window);
    } catch (e) {}if (A) {
      var t = "modernizr-" + Math.random(),
          r = A.open(t);r.onerror = function () {
    ...
    var A,
        ...
        o = !1;try {
      A = prefixed("indexedDB", window);
    } catch (i) {}if (!Modernizr.indexeddb || !Modernizr.indexeddb.deletedatabase) return !1;try {
    ...
    var A = prefixed("temporaryStorage", navigator),
        e = prefixed("persistentStorage", navigator);return !(!A || !e);
    ...
    var A = .2,
        e = prefixed("battery", navigator);return !!(e && !e.charging && e.level <= A);
  });var crypto = prefixed("crypto", window),
      supportsGetRandomValues;if (crypto && "getRandomValues" in crypto && "Uint32Array" in window) {
    var array = new Uint32Array(10),
        values = crypto.getRandomValues(array);supportsGetRandomValues = values && is(values[0], "number");
  }Modernizr.addTest("getrandomvalues", !!supportsGetRandomValues), Modernizr.addTest("backgroundblendmode", prefixed("backgroundBlendMode", "text")), Modernizr.addTest("objectfit", !!prefixed("objectFit"), { aliases: ["object-fit"] }), Modernizr.addTest("regions", function () {
    if (isSVG) return !1;var A = prefixed("flowFrom"),
        e = prefixed("flowInto"),
        t = !1;if (!A || !e) return t;var r = createElement("iframe"),
        n = createElement("div"),
        o = createElement("div"),
        i = createElement("div"),
        d = "modernizr_flow_for_regions_check";o.innerText = "M", n.style.cssText = "top: 150px; left: 150px; padding: 0px;", i.style.cssText = "width: 50px; height: 50px; padding: 42px;", i.style[A] = d, n.appendChild(o), n.appendChild(i), docElement.appendChild(n);var a,
        s,
        l = o.getBoundingClientRect();return o.style[e] = d, a = o.getBoundingClientRect(), s = parseInt(a.left - l.left, 10), docElement.removeChild(n), 42 == s ? t = !0 : (docElement.appendChild(r), l = r.getBoundingClientRect(), r.style[e] = d, a = r.getBoundingClientRect(), l.height > 0 && l.height !== a.height && 0 === a.height && (t = !0)), o = i = n = r = undefined, t;
  }), Modernizr.addTest("wrapflow", function () {
    var A = prefixed("wrapFlow");if (!A || isSVG) return !1;var e = A.replace(/([A-Z])/g, function (A, e) {
      return "-" + e.toLowerCase();
    }).replace(/^ms-/, "-ms-"),
        t = createElement("div"),
        r = createElement("div"),
        n = createElement("span");r.style.cssText = "position: absolute; left: 50px; width: 100px; height: 20px;" + e + ":end;", n.innerText = "X", t.appendChild(r), t.appendChild(n), docElement.appendChild(t);var o = n.offsetLeft;return docElement.removeChild(t), r = n = t = undefined, 150 == o;
  }), Modernizr.addTest("filesystem", !!prefixed("requestFileSystem", window)), Modernizr.addTest("requestautocomplete", !!prefixed("requestAutocomplete", createElement("form"))), Modernizr.addTest("speechrecognition", !!prefixed("SpeechRecognition", window));var url = prefixed("URL", window, !1);url = url && window[url], Modernizr.addTest("bloburls", url && "revokeObjectURL" in url && "createObjectURL" in url), Modernizr.addAsyncTest(function () {
    function A() {
      addTest("transferables", !1), e();
    }function e() {
      d && URL.revokeObjectURL(d), a && a.terminate(), n && clearTimeout(n);
    }var t = !!(Modernizr.blobconstructor && Modernizr.bloburls && Modernizr.webworkers && Modernizr.typedarrays);if (!t) return addTest("transferables", !1);try {
      var r,
          n,
          o = 'var hello = "world"',
          i = new Blob([o], { type: "text/javascript" }),
          d = URL.createObjectURL(i),
          a = new Worker(d);a.onerror = A, n = setTimeout(A, 200), r = new ArrayBuffer(1), a.postMessage(r, [r]), addTest("transferables", 0 === r.byteLength), e();
    } catch (s) {
      A();
    }
  }), Modernizr.addTest("peerconnection", !!prefixed("RTCPeerConnection", window)), Modernizr.addTest("datachannel", function () {
    if (!Modernizr.peerconnection) return !1;for (var A = 0, e = domPrefixes.length; e > A; A++) {
      var t = window[domPrefixes[A] + "RTCPeerConnection"];if (t) {
        var r = new t(null);return "createDataChannel" in r;
      }
    }return !1;
    ...
    Modernizr.addTest("csscolumns", function () {
      var A = !1,
          e = testAllProps("columnCount");try {
        A = !!e, A && (A = new Boolean(A));
      } catch (t) {}return A;
    });for (var A, e, t = ["Width", "Span", "Fill", "Gap", "Rule", "RuleColor", "RuleStyle", "RuleWidth", "BreakBefore", "BreakAfter", "BreakInside"], r = 0; r < t.length; r++) {
      A = t[r].toLowerCase(), e = testAllProps("column" + t[r]), ("breakbefore" === A || "breakafter" === A || "breakinside" == A) && (e = e || testAllProps(t[r])), Modernizr.addTest("csscolumns." + A, e);
    }
    ...
    if (Modernizr.supports) return testAllProps("filter", "blur(2px)");var A = createElement("a");return A.style.cssText = prefixes.join("filter:blur(2px); "), !!A.style.length && (document.documentMode === undefined || document.documentMode > 9);
      ...
      function t() {
        ...
        try {
          var e,
              ...
              n = "lebowski",
              o = !1,
              i = document.body.firstElementChild || document.body.firstChild;r.innerHTML = n + A + n, document.body.insertBefore(r, i), document.body.insertBefore(t, r), t.setSelectionRange ? (t.focus(), t.setSelectionRange(0, 0)) : t.createTextRange && (e = t.createTextRange(), e.collapse(!0), e.moveEnd("character", 0), e.moveStart("character", 0), e.select());try {
    ...
    var A = !1;if (!Modernizr.csstransitions || !window.getComputedStyle) return A;var e = '#modernizr:before { content:" "; font-size:5px;' + Modernizr._prefixes.join("transition:0s 100s;") + "}#modernizr.trigger:before { font-size:10px; }";return Modernizr.testStyles(e, function (e) {
  ...
  }), Modernizr.addTest("userselect", testAllProps("userSelect", "none", !0)), Modernizr.addTest("variablefonts", testAllProps("fontVariationSettings")), testRunner(), setClasses(classes), delete ModernizrProto.addTest, delete ModernizrProto.addAsyncTest;for (var i = 0; i < Modernizr._q.length; i++) {
    Modernizr._q[i]();
